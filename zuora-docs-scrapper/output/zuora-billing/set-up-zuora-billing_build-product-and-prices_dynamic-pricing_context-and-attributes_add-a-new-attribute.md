...
scraped_at: "2026-02-19T03:09:42.722Z"
---
...
3.  Enter the following details:
    ...
    | CRM Mapping | If the attribute maps to a CRM field (like Salesforce or another external system), enter the exact CRM Mapping Key here.This allows the system to sync data correctly with the external source.For details about CRM field mappings in Zuora CPQ, see Dynamic Pricing with CRM-mapped attributes using DSL. |
