---
title: "View details of bill runs through the reinvented UI"
url: "https://docs.zuora.com/en/zuora-billing/bill-your-customer/bill-runs/automate-billing-document-generation/bill-runs-information/view-details-of-bill-runs-through-the-reinvented-ui"
product: "zuora-billing"
scraped_at: "2025-12-24T08:27:02.763Z"
---

# View details of bill runs through the reinvented UI

Learn how to view detailed information about bill runs using the Zuora UI or REST API.

After creating a bill run, you can view its detailed information through either the Zuora UI or REST API.

To view information about a bill run through the REST API, use the [Retrieve a bill run](https://www.zuora.com/developer/api-references/api/operation/GET_BillRun/) operation.

1.  In the left navigation section, navigate to Billing > Bill Runs.
2.  On the Bill Runs page, click the number of the bill run that you want to view information about.
3.  On the bill run details page, view detailed information about the bill run.

    You can find the details of the bill run, including the general information, summary information, schedule information, settings, and history.


You can find the details of the bill run, including the general information, summary information, schedule information, settings, and history.

The following detailed information is all specific to the reinvented bill run details page.
