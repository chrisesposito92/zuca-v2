---
title: "Configure Avalara sandbox environment"
url: "https://docs.zuora.com/en/zuora-billing/bill-your-customer/leverage-advanced-capabilities/e-invoicing/e-invoicing-with-avalara/configure-avalara-sandbox-environment"
product: "zuora-billing"
scraped_at: "2025-12-24T08:40:45.256Z"
---

# Configure Avalara sandbox environment

Learn how to set up and configure the Avalara sandbox environment, including generating API keys, identifying country-specific tax information, and activating the Avalara E-Invoicing and Live Reporting product.

You need to collaborate with Avalara to set up your Avalara sandbox environment, Avalara may provide a sandbox environment to you. To configure the Avalara sandbox environment, complete the following tasks:
...
2.  Identify country and Tax ID mapping information required by Avalara. For more information, see [Country and Tax ID mapping required by Avalara](https://knowledge.avalara.com/bundle/nsz1680268923536_nsz1680268923536/page/jth1691652150367.html). Use Australia and Mexico as examples:
...
3.  Activate the Avalara E-Invoicing and Live Reporting product. The Avalara activation workflow is initiated when you onboard or [add a new company](https://knowledge.avalara.com/bundle/nsz1680268923536_nsz1680268923536/page/por1708433540384.html). The activation workflows vary with different countries in Avalara:
...
4.  As a first user or organization administrator, to onboard your Avalara E-Invoicing and Live Reporting product, you need to select a mandate and create users. For more information, see [Onboard E-Invoicing and Live Reporting](https://knowledge.avalara.com/bundle/nsz1680268923536_nsz1680268923536/page/pzn1729882674259.html). When selecting a mandate, the process differs. For more information, see [Select the mandate, platform, and network for your business](https://knowledge.avalara.com/bundle/nsz1680268923536_nsz1680268923536/page/nuk1680858104579.html). Use Australia and Mexico as examples:
    ...
    -   Ensure the business category in your Zuora account matches one of the settings in Avalara. For example, if you select B2B and B2C in Avalara and specify B2B in your Zuora account, the B2B data relevant data is finally transmitted. For more information, see [Configure e-invoicing profiles for accounts](/zuora-billing/bill-your-customer/leverage-advanced-capabilities/e-invoicing/e-invoicing-feature-configuration/configure-e-invoicing-profiles-for-accounts).
