...
url: "https://docs.zuora.com/en/zuora-billing/set-up-zuora-billing/apply-taxes/configurable-tax-apps/marketplace-apps/onesource-indirect-tax-determination-app/configure-the-onesource-indirect-tax-determination-app/1.-configure-templates"
product: "zuora-billing"
scraped_at: "2025-12-24T05:08:15.129Z"
---
...
5.  When you complete the configuration, click ![Configure icon](/db/organizations/zuora/repositories/prod-sitemap/content/documents/external_publications/billing/configurable_tax_apps/_media/configure_icon.png)
    and then select Preview Template to preview the configured template. If you want to start over, you can click ![Configure icon](/db/organizations/zuora/repositories/prod-sitemap/content/documents/external_publications/billing/configurable_tax_apps/_media/configure_icon.png)
