---
title: "Create invoice schedules on existing orders"
url: "https://docs.zuora.com/en/zuora-billing/bill-your-customer/leverage-advanced-capabilities/flexible-billing/billing-schedule/billing-schedule-tutorials/invoice-schedules-creation/create-invoice-schedules-on-existing-orders"
product: "zuora-billing"
scraped_at: "2025-12-24T18:33:55.860Z"
---

# Create invoice schedules on existing orders

Create custom invoice schedules for existing orders using the Zuora UI by following a series of steps to configure order details, additional information, and schedule items.

To create an invoice schedule on existing orders through the Zuora UI, perform the following steps:

1.  In the left navigation section, navigate to .
...
4.  In the Basic Information section, edit the orders and subscriptions that are associated with the invoice schedule if needed.
