---
title: "Payment Part data source"
url: "https://docs.zuora.com/en/zuora-platform/data/reporting/data-sources-and-exports/data-source-reference/payment-part-data-source"
product: "zuora-platform"
scraped_at: "2025-12-24T18:46:56.379Z"
---

# Payment Part data source

Data source to export the applied and unapplied portions of the payments

Note:

This feature is only available if you have Invoice Settlement enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memos, and Invoice Item Settlement. If you want to have access to the feature, see see [Invoice Settlement Enablement and Checklist Guide](/zuora-billing/bill-your-customer/invoice-settlement/get-started-with-invoice-settlement/invoice-settlement-migration-checklist-and-guide) for more information.
...
| --- | --- |
| Payment Part | The applied and unapplied portions of the payments. It includes the following fields:AmountBilling Document Owner IDCreated By IDCreated DateIDUpdated By IDUpdated Date |
...
| Payment Part FX Data | Contains Home Currency and Reporting Currency information.To enable this option, submit a request at Zuora Global Support. |
