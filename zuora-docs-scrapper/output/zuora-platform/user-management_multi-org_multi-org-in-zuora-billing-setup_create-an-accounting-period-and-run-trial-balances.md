---
title: "Create an accounting period and run trial balances"
url: "https://docs.zuora.com/en/zuora-platform/user-management/multi-org/multi-org-in-zuora-billing-setup/create-an-accounting-period-and-run-trial-balances"
product: "zuora-platform"
scraped_at: "2026-02-19T03:25:10.313Z"
---

# Create an accounting period and run trial balances
...
1.  Set up accounting periods See [Set up accounting periods](/accounts-receivable/finance/accounting-periods/set-up-accounting-periods) to learn more.
...
2.  Run a Trial Balance. Follow the steps mentioned in [Run a Trial Balance](/accounts-receivable/finance/accounting-periods/run-a-trial-balance/run-a-trial-balance-process).
