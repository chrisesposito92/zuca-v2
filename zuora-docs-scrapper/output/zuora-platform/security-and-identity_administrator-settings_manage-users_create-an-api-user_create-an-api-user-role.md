---
title: "Create an API user role"
url: "https://docs.zuora.com/en/zuora-platform/security-and-identity/administrator-settings/manage-users/create-an-api-user/create-an-api-user-role"
product: "zuora-platform"
scraped_at: "2026-02-19T03:20:00.505Z"
---

# Create an API user role

Learn how to create an API user role.

1.  Log in to Zuora as the tenant administrator.
2.  Click the user name at the top right and navigate to .
...
Create a user that has the API user role.
