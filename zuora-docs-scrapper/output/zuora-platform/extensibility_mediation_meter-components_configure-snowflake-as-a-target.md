...
scraped_at: "2025-12-24T05:30:16.915Z"
---
...
You can create a custom meter that uses a Snowflake data warehouse as a target. To create a meter with Snowflake as the target:

1.  Create a Custom Meter.
2.  Select Snowflake as the target. The Snowflake settings page is displayed. ![Snowflake target settings](https://zuora.deploy.heretto.com/v4/deployments/QPAZk6lsgXwvotedNERE/object/a3432f6a-c37d-43c4-907e-cb52cda4368d?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..1vBPIPolyLaW82fW6ELWofInyNORc72PR_BTtRjp-OI)
3.  Under the Snowflake Settings section, configure the following settings:
...
4.  Click Save to save the Snowflake target settings.

The custom meter is configured to use Snowflake as the target.
