...
4.  From the list of available templates, select View Template to view the query.
    ...
    Currently, Data Loader Exports support queries for the following objects:

    -   Accounts and Contacts
    -   Credit Memos from Charge
    -   Credit Memos from Invoice
    -   Debit Memos from Charge
    -   Debit Memos from Invoice
    -   Journal Runs
    -   Payments
    -   Products
