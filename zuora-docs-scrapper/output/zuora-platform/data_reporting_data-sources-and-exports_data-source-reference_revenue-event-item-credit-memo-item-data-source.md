---
title: "Revenue Event Item Credit Memo Item data source"
url: "https://docs.zuora.com/en/zuora-platform/data/reporting/data-sources-and-exports/data-source-reference/revenue-event-item-credit-memo-item-data-source"
product: "zuora-platform"
scraped_at: "2025-12-24T18:48:04.495Z"
---

# Revenue Event Item Credit Memo Item data source

Data source to export data about revenue event items that are associated with credit memo items

Use this data source to export data about revenue event items that are associated with credit memo items.

## Accessing the data source

​ Navigation: Reporting > Data Sources and select Revenue Event Item Credit Memo Item as the data source.
...
| --- | --- |
| Revenue Event Item Credit Memo Item | The revenue event item - credit memo item. It includes the following fields:AmountCreated By IDCreated DateCurrencyIDUpdated By IDUpdated Date |
...
| Revenue Event Credit Memo Item | Revenue event that is associated with a credit memo item. It includes the following fields:Created By IDCreated DateIDNotesRevenue Event NumberRevenue Event Recognition EndRevenue Event Recognition StartUpdated By IDUpdated Date |
