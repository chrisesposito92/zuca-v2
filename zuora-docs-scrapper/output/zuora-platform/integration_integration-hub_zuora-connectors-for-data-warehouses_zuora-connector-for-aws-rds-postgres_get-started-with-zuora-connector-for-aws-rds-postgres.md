---
title: "Get started with Zuora Connector for AWS RDS Postgres"
url: "https://docs.zuora.com/en/zuora-platform/integration/integration-hub/zuora-connectors-for-data-warehouses/zuora-connector-for-aws-rds-postgres/get-started-with-zuora-connector-for-aws-rds-postgres"
product: "zuora-platform"
scraped_at: "2026-01-15T22:01:19.023Z"
---

# Get started with Zuora Connector for AWS RDS Postgres

The prerequisites to get started with Zuora Connector for AWS RDS Postgres

Access to the AWS RDS Postgres connector may require purchasing a paid add-on. To get started, please reach out to your Zuora account representative for more information about the product. For confidentiality, Zuora recommends not publicly sharing pricing details and other terms.
...
Required information for setting up Zuora connector for AWS RDS Postgres:

1.  Zuora Tenant ID: Provide the tenant ID of the Zuora tenant from which you want to share data.
...
With the above details, Zuora will enable a UI for you where you can access the AWS RDS Postgres connector setup tab and complete the setup process yourself.

To guide you through the setup process for AWS RDS Postgres, see [Setup Zuora Connector for AWS RDS Postgres](https://knowledgecenter.zuora.com/Zuora_Platform/Integration/Zuora_Connectors_for_Data_Warehouses/Zuora_Connector_for_AWS_RDS_Postgres/Setup_Zuora_Connector_for_AWS_RDS_Postgres).
