...
url: "https://docs.zuora.com/en/zuora-platform/data-management/data-loader/data-loader-best-practices-and-scope/data-ingestion-using-bulk-jobs-api"
product: "zuora-platform"
scraped_at: "2026-01-15T21:58:42.601Z"
---

# Data ingestion using bulk jobs API

Learn how to performing data ingestion with a CSV file in Zuora Billing using the Data Loader Bulk Jobs API, ensuring data accuracy and reducing errors.

This article provides a step-by-step guide for performing data ingestion with a CSV file in Zuora Billing using the Data Loader Bulk Jobs API. This article provides a step-by-step guide for performing data ingestion with a CSV file in Zuora Billing using the [Data Loader Bulk Jobs API](https://developer.zuora.com/v1-api-reference/api/tag/Bulk-Data/). It outlines the required actions to ensure a seamless and efficient data ingestion process. In the context of data ingestion, this includes all jobs related to Import, Update, Delete, and Cancel.
...
4.  Creating a Data ingestion job with Bulk Jobs API
    ...
    API Requestcurl --request POST \\ --url 'https://rest.zuora.com/bulk-data/bulk-jobs' \\ --header 'Authorization: Bearer <YOUR\_ACCESS\_TOKEN>' \\ --header 'Content-Type: application/json' \\ --data '{ "name": "Import Accounts", "description": "A test Import file", "objectType": "Account", "jobType": "Import", "fileType": "csv" }'
