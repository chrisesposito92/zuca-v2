...
For more information, refer to the [Single Tenant upgrade scenario](/zuora-platform/user-management/multi-org/multi-org-configuration-and-enablement/multi-org-upgrade-models/upgrade-single-tenant-to-zuora-multi-org) for more details.
