---
title: "Customize an existing Account page layout to add the Payments related list"
url: "https://docs.zuora.com/en/zuora-platform/integration/integration-hub/zuora-360-and-zuora-360/configuration/assign-and-configure-page-layouts-for-payment-and-invoice/assign-the-billing-account-page-layout-to-user-profiles/customize-an-existing-account-page-layout-to-add-the-payments-related-list"
product: "zuora-platform"
scraped_at: "2025-12-24T18:34:42.379Z"
---

# Customize an existing Account page layout to add the Payments related list

Learn how to add the Payments related list to an existing Account page layout.

To customize an existing Account page layout to add the Payments related list:
