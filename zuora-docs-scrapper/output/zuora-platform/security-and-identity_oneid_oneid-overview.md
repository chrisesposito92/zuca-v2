...
url: "https://docs.zuora.com/en/zuora-platform/security-and-identity/oneid/oneid-overview"
product: "zuora-platform"
scraped_at: "2026-02-19T03:20:45.419Z"
---

# OneID overview

Zuora OneID is an identity and access management platform that enhances security and streamlines user access across Zuora applications, ensuring compliance with regulatory standards.
...
## Organization and tenants for Zuora OneID users
