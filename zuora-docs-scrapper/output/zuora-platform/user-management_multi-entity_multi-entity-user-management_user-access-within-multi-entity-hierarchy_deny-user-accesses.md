...
url: "https://docs.zuora.com/en/zuora-platform/user-management/multi-entity/multi-entity-user-management/user-access-within-multi-entity-hierarchy/deny-user-accesses"
product: "zuora-platform"
scraped_at: "2026-02-20T17:47:14.495Z"
---
...
This user remains in the user list in the entity even if the access request is denied. You can [give the user access](/zuora-platform/user-management/multi-entity/multi-entity-user-management/user-access-within-multi-entity-hierarchy/grant-user-access-to-other-entities)later.
