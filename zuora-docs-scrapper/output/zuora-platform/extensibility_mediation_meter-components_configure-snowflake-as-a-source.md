...
scraped_at: "2025-12-24T05:29:19.091Z"
---
...
You can create a custom meter that uses a Snowflake data warehouse source for event data. To create a meter with Snowflake as the source:

1.  Create a Custom Meter.
2.  Select Snowflake as the source. The Snowflake settings page is displayed. ![Snowflake source settings](https://zuora.deploy.heretto.com/v4/deployments/QPAZk6lsgXwvotedNERE/object/1a45f65d-18bc-4a69-9667-577a299845ec?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..4PN2iQDKmxLk7tFFpvn4UXkV5908I2c_IORFMesVGkg)
3.  Click Select to select an Event Definition on the Snowflake settings page. You can create or select an existing Event Definition or import an Event Definition.
...
5.  Click Save to save the Snowflake source settings.

The custom meter is configured to use Snowflake as a source.
