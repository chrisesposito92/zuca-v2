---
title: "Revenue Schedule Item Debit Memo Item data source"
url: "https://docs.zuora.com/en/zuora-platform/data/reporting/data-sources-and-exports/data-source-reference/revenue-schedule-item-debit-memo-item-data-source"
product: "zuora-platform"
scraped_at: "2025-12-24T18:48:24.157Z"
---

# Revenue Schedule Item Debit Memo Item data source

Data source to export revenue schedule item debit memo item data

Use this data source to export revenue schedule item debit memo item data.

## Accessing the data source

​ Navigation: Reporting > Data Sources and select Revenue Schedule Item Debit Memo Item as the data source.
...
| --- | --- |
| Revenue Schedule Item Debit Memo Item | The revenue schedule item - debit memo item. It includes the following fields:AmountCreated By IDCreated DateCurrencyIDUpdated By IDUpdated Date |
...
| Revenue Schedule Item Debit Memo Item FX Data | Contains Home Currency and Reporting Currency information.To enable this option, submit a request at Zuora Global Support. |
