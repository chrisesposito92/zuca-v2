...
url: "https://docs.zuora.com/en/zuora-platform/user-management/multi-org/multi-org-configuration-for-extended-zuora-modules_1/setup-multi-org-for-billing-and-revenue-integration"
product: "zuora-platform"
scraped_at: "2026-01-15T22:00:43.572Z"
---
...
1.  Step 1: Sync Zuora Billing's Multi-org enabled tenants to Zuora Revenue.
    ...
    1.  Navigate to Zuora Revenue and complete the steps mentioned in .

    2.  In the Program name dropdown, select ‘RevPro 3.0 Billing Entity ID Sync process’ from the Predefined Programs
...
2.  Step 2:Sync FXrate from Zuora Billing to Zuora Revenue
    ...
    1.  Navigate to Zuora Revenue and complete the steps given in Schedule Jobs
...
2.  From the right side menu ![Open side-menu](https://zuora.deploy.heretto.com/v4/deployments/QPAZk6lsgXwvotedNERE/object/61122d92-0110-4141-9fa7-91af1db488f6?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..t3M9d1DAs_T4VOdMIdFbFaaE3O4Dk6NowbaJ3FOqm1s) select Organization .
...
-   A Revpro user can access the orgs. based on their role privileges. to manage user roles.

-   Zuora Revenue supports all out-of-the-box reporting for the synced orgs. \\ for more details.
