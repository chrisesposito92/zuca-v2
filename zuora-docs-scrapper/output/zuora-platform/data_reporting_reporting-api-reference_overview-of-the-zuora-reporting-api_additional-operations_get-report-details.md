...
url: "https://docs.zuora.com/en/zuora-platform/data/reporting/reporting-api-reference/overview-of-the-zuora-reporting-api/additional-operations/get-report-details"
product: "zuora-platform"
scraped_at: "2025-12-24T18:49:30.889Z"
---

# Get Report Details

A Reporting API that returns the report definition and other metadata for the ReportId specified
...
The Get Report Details Reporting API returns the report definition and other metadata for the ReportId specified.

Get Report Details requires a ReportId value as a request path value. ReportId is available from the response to many different API calls. You can call [Search by Report Name](/zuora-platform/data/reporting/reporting-api-reference/overview-of-the-zuora-reporting-api/search-by-report-name) or [Get Reports by Label](/zuora-platform/data/reporting/reporting-api-reference/overview-of-the-zuora-reporting-api/additional-operations/get-reports-by-label) and the ReportId will be the `id` value in the JSON response. You can also make the following call to list all reports: `GET https://zconnectsandbox.zuora.com/api/rest/v1/reports`

## Request

| Environment | Request |
| --- | --- |
| API Sandbox (US Data Center) | GET https://zconnectsandbox.zuora.com/api/rest/v1/reports/{ReportId}/report-details |
| Production (US Data Center) | GET https://zconnect.zuora.com/api/rest/v1/reports/{ReportId}/report-details |
| API Sandbox (EU Data Center) | GET https://zconnect.sandbox.eu.zuora.com/api/rest/v1/reports/{ReportId}/report-details |
| Production (EU Data Center) | GET https://zconnect.eu.zuora.com/api/rest/v1/reports/{ReportId}/report-details |
| API Sandbox(US Cloud Data Center) | GET https://zconnect.sandbox.na.zuora.com/api/rest/v1/reports/{ReportId}/report-details |
| Production (US Cloud Data Center) | GET https://zconnect.na.zuora.com/api/rest/v1/reports/{ReportId}/report-details |
...
`GET https://zconnectsandbox.zuora.com/api/rest/v1/reports/0000000050b0ade40150b4966498003f/report-details`
