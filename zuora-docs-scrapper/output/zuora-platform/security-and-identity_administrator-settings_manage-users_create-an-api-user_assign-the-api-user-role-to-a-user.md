...
url: "https://docs.zuora.com/en/zuora-platform/security-and-identity/administrator-settings/manage-users/create-an-api-user/assign-the-api-user-role-to-a-user"
product: "zuora-platform"
scraped_at: "2026-02-19T03:20:00.140Z"
---
...
Ensure that a user role with the API Write Access is available in your tenant. See [Create an API user role](/zuora-platform/security-and-identity/administrator-settings/manage-users/create-an-api-user/create-an-api-user-role).
