...
scraped_at: "2026-02-19T03:26:52.747Z"
---
...
3.  Select Currency Lookup as the processor.
4.  Select options for the From and To sections. You can select different currencies or select from even fields.
...
5.  Select a Rate Type from the drop-down list.
...
6.  Select the Date Field to determine the time format.
7.  Enter the Rate Field Name that will be returned return from Finance.
