...
url: "https://docs.zuora.com/en/zuora-platform/data-management/deployment-manager/deployment-manager-product-catalog/product-catalog-deployment-faqs"
product: "zuora-platform"
scraped_at: "2026-02-19T03:18:39.310Z"
---
...
1.  What does the following error in view logs mean? Why do I get this error message?
    ...
    A product can be created in the target tenant when the difference in the SKU is not more than 2. Refer to [General Deployment Facts](/zuora-platform/data-management/deployment-manager/deployment-manager-product-catalog/product-catalog-deployment-reference-facts) for more information.

2.  How do I resolve the following error shown in the View Logs?

    ![Product atalog error logs](https://zuora.deploy.heretto.com/v4/deployments/QPAZk6lsgXwvotedNERE/object/8eb25686-6ea6-41f0-8e3c-6d933056b311?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..bySe04OHo9J0y1nnSgOucdFztXrJnJ1d0LS5hsEqM2c)
...
7.  I cannot see some products, rate plans and rate plan charges on the compare screen? Is there a problem?
    ...
    See [Best Practices for managing Product Catalog in tenants](/zuora-platform/data-management/deployment-manager/deployment-manager-product-catalog/best-practices-for-managing-product-catalog-across-tenants) for more information.
