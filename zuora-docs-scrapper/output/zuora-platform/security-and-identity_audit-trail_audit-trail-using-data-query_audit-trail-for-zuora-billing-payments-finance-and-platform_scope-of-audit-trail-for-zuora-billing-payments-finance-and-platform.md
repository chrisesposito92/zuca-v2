...
url: "https://docs.zuora.com/en/zuora-platform/security-and-identity/audit-trail/audit-trail-using-data-query/audit-trail-for-zuora-billing-payments-finance-and-platform/scope-of-audit-trail-for-zuora-billing-payments-finance-and-platform"
product: "zuora-platform"
scraped_at: "2026-02-19T03:23:16.282Z"
---
...
-   Track, log, and report on changes of the following business objects. For more information about tracking subscription and billing document histories, see [Financial transaction histories](/zuora-platform/security-and-identity/audit-trail/audit-trail-using-data-query/audit-trail-for-zuora-billing-payments-finance-and-platform#concept-3117__title-23335) .
    ...
    -   Custom Logic (see [Data Model of Audit Trail](/zuora-platform/security-and-identity/audit-trail/audit-trail-using-data-query/data-model-of-audit-trail) for supported objects)

    -   Custom Object (see [Data Model of Audit Trail](/zuora-platform/security-and-identity/audit-trail/audit-trail-using-data-query/data-model-of-audit-trail) for supported objects)
    ...
    -   Notification (see [Data Model of Audit Trail](/zuora-platform/security-and-identity/audit-trail/audit-trail-using-data-query/data-model-of-audit-trail) for supported objects)

    -   Order Line Item

        -   Fulfillment

    -   Product Catalog (see [Data Model of Audit Trail](/zuora-platform/security-and-identity/audit-trail/audit-trail-using-data-query/data-model-of-audit-trail) for supported objects)
    ...
    -   Workflow (see [Data Model of Audit Trail](/zuora-platform/security-and-identity/audit-trail/audit-trail-using-data-query/data-model-of-audit-trail) for supported objects)
...
-   Administrators can enable or disable auditing the above objects through [Manage Audit Trail Settings](/zuora-platform/security-and-identity/administrator-settings/manage-audit-trail-settings) .
...
-   To audit custom field changes of a custom object, you must set the custom field as an auditable field. One custom object can have a maximum of five auditable fields. For more information, see [Create a new custom object definition](/zuora-platform/extensibility/custom-objects/custom-object-definition-management/create-a-new-custom-object-definition) .
