...
url: "https://docs.zuora.com/en/zuora-platform/user-management/multi-org/multi-org-in-zuora-billing-setup/create-a-payment-and-status-check"
product: "zuora-platform"
scraped_at: "2026-02-20T17:47:51.798Z"
---
...
4.  Specify the payment run information mentioned in Steps 3 - 10 in the [Create payment run](/zuora-payments/process-payments/process-payments/process-payments-with-payment-runs/create-payment-runs/create-a-payment-run) Specify the payment run information mentioned in Steps 3 - 10 in the Create payment run to complete the bill run creation.
