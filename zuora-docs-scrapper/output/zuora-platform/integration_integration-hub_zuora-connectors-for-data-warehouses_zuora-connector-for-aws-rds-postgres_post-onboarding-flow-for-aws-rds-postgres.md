---
title: "Post-onboarding flow for AWS RDS Postgres"
url: "https://docs.zuora.com/en/zuora-platform/integration/integration-hub/zuora-connectors-for-data-warehouses/zuora-connector-for-aws-rds-postgres/post-onboarding-flow-for-aws-rds-postgres"
product: "zuora-platform"
scraped_at: "2026-02-20T21:12:30.102Z"
---

# Post-onboarding flow for AWS RDS Postgres

Know about the post-onboarding flow for AWS RDS Postgres
...
Zuora connectors require the destination to be accessible over the public internet. Whitelist the appropriate Zuora outbound IP addresses in your AWS RDS Postgres environment based on your tenant’s environment.

For the list of IPs to whitelist, refer to [Get started with Zuora Connector for AWS RDS Postgres](/zuora-platform/integration/integration-hub/zuora-connectors-for-data-warehouses/zuora-connector-for-aws-rds-postgres/get-started-with-zuora-connector-for-aws-rds-postgres).
