...
url: "https://docs.zuora.com/en/zuora-platform/user-management/multi-org/multi-org-configuration-and-management/assign-users-to-one-or-more-org-units"
product: "zuora-platform"
scraped_at: "2026-02-20T17:46:58.064Z"
---
...
Before assigning users to various organizations, you must enable the [org hierarchy](/zuora-platform/user-management/multi-org/multi-org-configuration-and-management/create-an-org-hierarchy) . This step is mandatory since the associated org unit must be specified during user creation.
...
3.  On the new user creation page, fill in the basic information along with the fields mentioned below:
    ...
    -   Zuora Platform Role: You can select a Zuora Platform Role and other roles for the user. You define and manage user roles on the [Manage User Roles](https://knowledgecenter.zuora.com/Zuora_Platform/System_Management/Administrator_Settings/User_Roles) settings page.

    See [Personal Settings](/zuora-platform/system-management/additional-tenant-management-settings/personal-settings) for more information about the fields that you can set when creating a user.
