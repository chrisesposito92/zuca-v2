---
title: "Get started with Zuora connector for GCP Postgres"
url: "https://docs.zuora.com/en/zuora-platform/integration/integration-hub/zuora-connectors-for-data-warehouses/zuora-connector-for-gcp-postgres/get-started-with-zuora-connector-for-gcp-postgres"
product: "zuora-platform"
scraped_at: "2025-12-24T18:31:19.248Z"
---

# Get started with Zuora connector for GCP Postgres

The prerequisites to get started with Zuora Connector for GCP Postgres

Please see the section "Zuora connectors - Outbound IP whitelisting requirement" on this page.

To begin the setup process for the Zuora Connector for GCP Postgres, please ensure you have the following prerequisites:
...
-   GCP Postgres Database: Ensure that your GCP Postgres database is pre-configured and ready for connection. Make sure you have the necessary permissions to manage and access the database.

-   GCP Postgres Database Credentials: You will need the username and password for your GCP Postgres database to establish the connection.


Once you have these prerequisites in place, you can proceed with the configuration steps to establish the connection between your Zuora account and your GCP Postgres database. This enables streamlined data synchronization and enhances your data storage and analytics capabilities.

For information on the setup process, refer to [Set up Zuora Connector for GCP Postgres](/zuora-platform/integration/integration-hub/zuora-connectors-for-data-warehouses/zuora-connector-for-gcp-postgres/set-up-zuora-connector-for-gcp-postgres).
