---
title: "Get started with Zuora connector for Generic Postgres"
url: "https://docs.zuora.com/en/zuora-platform/integration/integration-hub/zuora-connectors-for-data-warehouses/zuora-connector-for-generic-postgres/get-started-with-zuora-connector-for-generic-postgres"
product: "zuora-platform"
scraped_at: "2025-12-24T18:32:14.577Z"
---

# Get started with Zuora connector for Generic Postgres

The prerequisites to get started with Zuora Connector for Generic Postgres

Access to the Generic Postgres connector may require purchasing a paid add-on. To get started, please reach out to your Zuora account representative for more information about the product. For confidentiality, Zuora recommends not publicly sharing pricing details and other terms.
...
Required information to setup Zuora connector for Generic Postgres:
...
With the above details, Zuora will enable a UI for you where you can access the Generic Postgres connector setup tab and complete the setup process yourself.

To guide you through the setup process for Generic Postgres, see [Setup Zuora Connector for Generic Postgres](/zuora-platform/integration/integration-hub/zuora-connectors-for-data-warehouses/zuora-connector-for-generic-postgres/set-up-zuora-connector-for-generic-postgres).
