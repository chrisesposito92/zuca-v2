---
title: "QueryRefundApplicationItemByKey"
url: "https://developer.zuora.com/v1-api-reference/api/operation/queryRefundApplicationItemByKey/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:10:24.385Z"
---

## Retrieve a refund application item

Retrieve the details of a specific Refund Application Item object.
...
get/object-query/refund-application-items/{key}
...
curl \-i \-X GET \\
  'https://rest.test.zuora.com/object-query/refund-application-items/{key}?pageSize=10&cursor=string&sort%5B%5D=string&expand%5B%5D=refundapplication&filter%5B%5D=string&fields%5B%5D=string&includeNullFields=false' \\
