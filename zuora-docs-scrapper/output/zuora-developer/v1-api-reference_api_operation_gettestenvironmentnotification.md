---
title: "GetTestEnvironmentNotification"
url: "https://developer.zuora.com/v1-api-reference/api/operation/getTestEnvironmentNotification/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:26:45.890Z"
---

## Retrieve a notification response of a test environment

Use this operation to retrieve a specific notification associated with a Test Environment by its unique notification ID. It handles HTTP GET requests to the /test-environments/{id}/notifications/{notificationId} endpoint and returns a TestEnvironmentNotificationResponse object if the notification is found. If the specified notification does not exist, it returns a 404 error.
