---
title: "POST UploadFileForCreditMemo"
url: "https://developer.zuora.com/v1-api-reference/api/operation/POST_UploadFileForCreditMemo/"
product: "zuora-developer"
scraped_at: "2026-01-02T06:55:05.235Z"
---
...
| creditMemoKeyrequired | stringThe ID or number of the credit memo that you want to upload a PDF file for. For example, 402890555a7e9791015a879f064a0054 or CM00000001. |
| --- | --- |
...
| file | string <binary>The PDF file to upload for the credit memo. |
| --- | --- |
...
post/v1/credit-memos/{creditMemoKey}/files
