...
url: "https://developer.zuora.com/other-api/quickstart-api/operation/updateFulfillment/"
product: "zuora-developer"
scraped_at: "2026-01-02T06:42:04.307Z"
---
...
| order_line_item_id | stringThe unique identifier of the associated order line item. |
| --- | --- |
| target_date | string <date>All order line items associated with this fulfillment that were unbilled on or before this date are included in future bill runs. |
...
| fulfillment_date | string <date>The date of the fulfillment. |
...
patch/fulfillments/{fulfillment\_id}
