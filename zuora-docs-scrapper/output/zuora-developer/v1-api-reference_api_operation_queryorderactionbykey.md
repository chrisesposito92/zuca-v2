---
title: "QueryOrderActionByKey"
url: "https://developer.zuora.com/v1-api-reference/api/operation/queryOrderActionByKey/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:07:12.379Z"
---

## Retrieve an order action

Retrieve the details of a specific Order Action object.
...
get/object-query/order-actions/{key}
...
curl \-i \-X GET \\
  'https://rest.test.zuora.com/object-query/order-actions/{key}?pageSize=10&cursor=string&sort%5B%5D=string&expand%5B%5D=subscription&filter%5B%5D=string&fields%5B%5D=string&includeNullFields=false' \\
