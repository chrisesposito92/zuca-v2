...
url: "https://developer.zuora.com/other-api/quickstart-api/operation/cancelSubscription/"
product: "zuora-developer"
scraped_at: "2026-01-02T06:41:41.954Z"
---
...
| cancel_date | stringDate on which the subscription is canceled. |
| --- | --- |
| cancel_at | stringThe date on which the subscription is canceled. Can be either the end of the subscription term or the end of the billing period.Enum: "invoice_period_end" "subscription_term_end" |
| processing_options | object (ProcessingOptions)Processing options for the invoice or payment. |
| refund_amount | numberAmount to be refunded |
| write_off | booleanDefault: falseIndicates whether to write off the outstanding balance on the invoice after canceling the subscription. |
| write_off_behavior | object (WriteOffSuscriptionRequest)The financial information of the credit memo items generated to write off the invoice balance. |
...
post/subscriptions/{subscription\_id}/cancel
