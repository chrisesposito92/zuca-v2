---
title: "QueryContactSnapshotByKey"
url: "https://developer.zuora.com/v1-api-reference/api/operation/queryContactSnapshotByKey/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:11:14.496Z"
---
...
| keyrequired | stringThe unique identifier of the contact snapshot to retrieve. |
| --- | --- |
...
| sort[] | Array of stringsA case-insensitive query parameter that specifies the sort order of the list, which can be either ascending (e.g. accountnumber.ASC) or descending (e.g. accountnumber.DESC). You cannot sort on properties in arrays. If the array-type properties are specified for the sort[] parameter, they are ignored. The fields that can be sorted include:idupdateddatecontactid |
| expand[] | Array of stringsAllows you to expand responses by including related object information in a single call. |
| filter[] | Array of stringsA case-insensitive filter on the list. The available options include:idupdateddatecontactid{indexedcustomfield} |
...
curl \-i \-X GET \\
  'https://rest.test.zuora.com/object-query/contact-snapshots/{key}?pageSize=10&cursor=string&sort%5B%5D=string&expand%5B%5D=string&filter%5B%5D=string&fields%5B%5D=string&includeNullFields=false' \\
