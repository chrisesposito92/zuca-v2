---
title: "QueryProductRatePlanCharges"
url: "https://developer.zuora.com/v1-api-reference/api/operation/queryProductRatePlanCharges/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:08:56.307Z"
---

## List product rate plan charges

Lists Product Rate Plan Charge objects. You can use the query parameters to filter, expand, and sort the returned results.
...
| sort[] | Array of stringsA case-insensitive query parameter that specifies the sort order of the list, which can be either ascending (e.g. accountnumber.ASC) or descending (e.g. accountnumber.DESC). You cannot sort on properties in arrays. If the array-type properties are specified for the sort[] parameter, they are ignored. Supported sortable fields:idupdateddatebillcycledaychargemodelproductrateplanchargenumberproductrateplanid |
| expand[] | Array of stringsAllows you to expand responses by including related object information in a single call.Items Enum: "productrateplan" "productrateplanchargetiers" |
| filter[] | Array of stringsA case-insensitive filter on the list.Supported filterable fields:idupdateddatebillcycledaychargemodelchargetypeisprepaidproductrateplanchargenumberproductrateplanid{indexedcustomfield}: Use the format like customField__c to filter on custom fields. |
...
get/object-query/product-rate-plan-charges
...
curl \-i \-X GET \\
  'https://rest.test.zuora.com/object-query/product-rate-plan-charges?pageSize=10&cursor=string&sort%5B%5D=string&expand%5B%5D=productrateplan&filter%5B%5D=string&fields%5B%5D=string&includeNullFields=false' \\
...
-   "nextPage": "W3sidmFsdWUiOiIyMDIzLTA4LTAyVDIwOjM5OjMwLTA3OjAwIiwib3JkZXJCeSI6eyJmaWVsZCI6IlVwZGF0ZWREYXRlIiwib3JkZXIiOiJERVNDIn19LHsidmFsdWUiOiI4YWQwOTQwODg5YjcxZmMyMDE4OWI5N2FhNjVlMmVhOSIsIm9yZGVyQnkiOnsiZmllbGQiOiJJZCIsIm9yZGVyIjoiREVTQyJ9fV0=",
...
-   "data": [
    ...
    -   {
        ...
        -   "createdDate": "2025-02-19T23:44:10-08:00",
        ...
        -   "id": "f94fbebf60e95218276522506ac30001",
        ...
        -   "updatedDate": "2025-02-19T23:44:10-08:00",

        -   "useTenantDefaultForPriceChange": true,

        -   "validityPeriodType": "SubscriptionTerm"
