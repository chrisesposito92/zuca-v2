---
title: "Object POSTProductRatePlan"
url: "https://developer.zuora.com/v1-api-reference/api/operation/Object_POSTProductRatePlan/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:29:42.581Z"
---
...
| ActiveCurrencies | Array of stringsA list of 3-letter currency codes representing active currencies for the product rate plan. Use a comma to separate each currency code.When creating a product rate plan, you can use this field to specify default currency and at most four other active currencies. |
| --- | --- |
...
| Namerequired | string <= 255 charactersThe name of the product rate plan. The name doesn't have to be unique in a Product Catalog, but the name has to be unique within a product. |
| ProductIdrequired | string <= 32 charactersThe ID of the product that contains the product rate plan. |
| ProductRatePlanNumber | string <= 100 charactersThe natural key of the product rate plan.Possible values:leave null for automatically generated stringan alphanumeric string of 100 characters or fewerNote: This field is only available if you set the X-Zuora-WSDL-Version request header to 133 or later. |
