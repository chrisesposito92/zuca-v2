---
title: "QueryProductRatePlanChargeByKey"
url: "https://developer.zuora.com/v1-api-reference/api/operation/queryProductRatePlanChargeByKey/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:08:55.918Z"
---

## Retrieve a product rate plan charge

Retrieve the details of a specific Product Rate Plan Charge object.
...
| keyrequired | stringID of a product rate plan charge. |
| --- | --- |
...
| expand[] | Array of stringsItems Enum: "productrateplan" "productrateplanchargetiers" |
...
get/object-query/product-rate-plan-charges/{key}
...
curl \-i \-X GET \\
  'https://rest.test.zuora.com/object-query/product-rate-plan-charges/{key}?pageSize=10&cursor=string&sort%5B%5D=string&expand%5B%5D=productrateplan&filter%5B%5D=string&fields%5B%5D=string&includeNullFields=false' \\
