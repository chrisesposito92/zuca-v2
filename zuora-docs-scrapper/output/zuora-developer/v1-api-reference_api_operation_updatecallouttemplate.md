---
title: "UpdateCalloutTemplate"
url: "https://developer.zuora.com/v1-api-reference/api/operation/UpdateCalloutTemplate/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:14:41.801Z"
---
...
| idrequired | string <uuid>The ID of the callout template to be updated. |
| --- | --- |
...
| httpMethod | stringThe HTTP method of the callout.Enum: "POST" "GET" "PUT" "PATCH" "DELETE" |
| name | string <= 255 charactersThe name of the callout template. It must be unique across all callout templates. |
