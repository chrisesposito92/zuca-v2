---
title: "CreateProduct"
url: "https://developer.zuora.com/other-api/quickstart-api/operation/createProduct/"
product: "zuora-developer"
scraped_at: "2026-01-02T06:39:40.400Z"
---
...
| fields[] | Array of stringsAllows you to specify which fields are returned in the response.Accepted values custom_fields, created_by_id, updated_by_id, created_time, id, updated_time, start_date, end_date, active, name, type, sku, descriptionExample: fields[]=id,created_time |
| --- | --- |
| product.fields[] | Array of stringsDeprecatedAllows you to specify which fields are returned in the response.Accepted values custom_fields, created_by_id, updated_by_id, created_time, id, updated_time, start_date, end_date, active, name, type, sku, descriptionExample: product.fields[]=id,created_time |
| plans.fields[] | Array of stringsAllows you to specify which fields are returned in the response.Accepted values custom_fields, created_by_id, updated_by_id, created_time, id, updated_time, start_date, end_date, name, active, description, plan_number, product_id, active_currenciesExample: plans.fields[]=id,created_time |
...
| --- | --- |
| start_date | string <date>The date from which the product can be used for new purchases. |
| end_date | string <date>The date on which the product can no longer be used for new purchases. |
| namerequired | stringThe name of the product. |
| type | stringThe type of product.Enum: "base" "add_on" "other" |
| sku | stringThe sku identifier of the product. |
