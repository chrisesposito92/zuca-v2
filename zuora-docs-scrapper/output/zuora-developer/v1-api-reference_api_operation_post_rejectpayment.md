---
title: "POST RejectPayment"
url: "https://developer.zuora.com/v1-api-reference/api/operation/POST_RejectPayment/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:01:38.254Z"
---

## Reject a payment

If the [Asynchronous Payment Statuses](https://knowledgecenter.zuora.com/Zuora_Payments/Payment_Operations/DA_Electronic_Payment_Processing#Asynchronous_payment_flow) feature is not enabled, this API operation sets the Gateway State field of the payment to `FailedToSettle`, creates a refund for the payment amount, and returns the Refund object as response.
...
If the reason code "Payment Rejection" is active in the [Reason Codes](https://knowledgecenter.zuora.com/Zuora_Payments/Payment_Operations/Reason_Codes_for_Payment_Operations/B_Creating_and_Editing_Reason_Codes) list, the reason code of the external refund is set to "Payment Rejection". Otherwise, the default reason code in the list is used.
...
| secondReferenceId | string <= 100 charactersThe second reference Id. Some gateway uses two unique transaction IDs. |
