---
title: "QueryFulfillmentByKey"
url: "https://developer.zuora.com/v1-api-reference/api/operation/queryFulfillmentByKey/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:06:45.389Z"
---
...
| keyrequired | stringID or number of the fulfillment. |
| --- | --- |
...
| filter[] | Array of stringsA case-insensitive filter on the list.Supported filterable fields:idcreateddateupdateddateorderlineitemid - fulfillmentnumberstateexternalid{indexedcustomfield}: Use the format like customField__c to filter on custom fields. |
...
curl \-i \-X GET \\
  'https://rest.test.zuora.com/object-query/fulfillments/{key}?pageSize=10&cursor=string&sort%5B%5D=string&expand%5B%5D=string&filter%5B%5D=string&fields%5B%5D=string&includeNullFields=false' \\
