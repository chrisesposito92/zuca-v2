---
title: "GET PaymentItemPart"
url: "https://developer.zuora.com/v1-api-reference/api/operation/GET_PaymentItemPart/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:02:04.961Z"
---
...
| --- | --- |
| itempartidrequired | stringThe unique ID of a specific payment part item. You can get the payment part item ID from the response of List all payment part items. |
...
get/v1/payments/{paymentKey}/parts/{partid}/item-parts/{itempartid}
...
curl \-i \-X GET \\
  'https://rest.test.zuora.com/v1/payments/{paymentKey}/parts/{partid}/item-parts/{itempartid}' \\
