---
title: "QueryRatePlanByKey"
url: "https://developer.zuora.com/v1-api-reference/api/operation/queryRatePlanByKey/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:09:14.111Z"
---

## Retrieve a rate plan

Retrieve the details of a specific Rate Plan object.
...
| keyrequired | stringID of a rate plan. |
| --- | --- |
...
get/object-query/rate-plans/{key}
...
curl \-i \-X GET \\
  'https://rest.test.zuora.com/object-query/rate-plans/{key}?pageSize=10&cursor=string&sort%5B%5D=string&expand%5B%5D=subscription&filter%5B%5D=string&fields%5B%5D=string&includeNullFields=false' \\
