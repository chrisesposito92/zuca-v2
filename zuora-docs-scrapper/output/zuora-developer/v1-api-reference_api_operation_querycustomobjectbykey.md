---
title: "QueryCustomObjectBykey"
url: "https://developer.zuora.com/v1-api-reference/api/operation/queryCustomObjectBykey/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:11:11.129Z"
---
...
| custom-object-namerequired | stringCustom Object Name with NameSpace, for example, default__cars. |
| --- | --- |
| keyrequired | stringObject ID. |
...
curl \-i \-X GET \\
  'https://rest.test.zuora.com/object-query/{custom-object-name}/{key}?pageSize=10&cursor=string&expand%5B%5D=string&filter%5B%5D=string&fields%5B%5D=string&includeNullFields=false' \\
