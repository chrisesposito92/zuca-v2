---
title: "UnapplyPayment"
url: "https://developer.zuora.com/other-api/quickstart-api/operation/unapplyPayment/"
product: "zuora-developer"
scraped_at: "2026-01-02T06:45:30.723Z"
---
...
| effective_date | string <date>The date and time when the payment takes effect. |
| --- | --- |
| billing_documentsrequired | Array of objects (BillingDocumentPaymentApplicationRequest)Indicates to which billing documents (invoices or debit memos) are the payment applied. |
...
put/payments/{payment\_id}/unapply
