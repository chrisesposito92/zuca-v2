---
title: "QueryRefundApplicationItems"
url: "https://developer.zuora.com/v1-api-reference/api/operation/queryRefundApplicationItems/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:10:46.878Z"
---
...
| expand[] | Array of stringsAllows you to expand responses by including related object information in a single call.Items Value: "refundapplication" |
| filter[] | Array of stringsA case-insensitive filter on the list.Supported filterable fields:idupdateddate{indexedcustomfield}: Use the format like customField__c to filter on custom fields. |
...
curl \-i \-X GET \\
  'https://rest.test.zuora.com/object-query/refund-application-items?pageSize=10&cursor=string&sort%5B%5D=string&expand%5B%5D=refundapplication&filter%5B%5D=string&fields%5B%5D=string&includeNullFields=false' \\
