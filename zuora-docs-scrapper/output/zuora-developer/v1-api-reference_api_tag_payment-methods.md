...
url: "https://developer.zuora.com/v1-api-reference/api/tag/Payment-Methods/"
product: "zuora-developer"
scraped_at: "2026-01-02T06:59:32.202Z"
---
...
](/v1-api-reference/api/operation/POST_PaymentMethods/)[

post

Create an Apple Pay payment method

](/v1-api-reference/api/operation/POST_PaymentMethodsDecryption/)[

delete

Delete a payment method

](/v1-api-reference/api/operation/DELETE_PaymentMethods/)[

get

Retrieve a payment method

](/v1-api-reference/api/operation/GET_PaymentMethod/)[

put

Update a payment method

](/v1-api-reference/api/operation/PUT_PaymentMethod/)[

put

Verify a payment method

](/v1-api-reference/api/operation/PUT_VerifyPaymentMethods/)[

put

Scrub a payment method

](/v1-api-reference/api/operation/PUT_ScrubPaymentMethods/)[

get

Retrieve the balance of a bank account

](/v1-api-reference/api/operation/getBankAccountBalance/)[

get

List stored credential profiles of a payment method

](/v1-api-reference/api/operation/GET_StoredCredentialProfiles/)[

post

Create a stored credential profile

](/v1-api-reference/api/operation/POST_CreateStoredCredentialProfile/)[

post

Cancel a stored credential profile

](/v1-api-reference/api/operation/POST_CancelStoredCredentialProfile/)[

post

Expire a stored credential profile

](/v1-api-reference/api/operation/POST_ExpireStoredCredentialProfile/)[

get

List registered Apple Pay domains

](/v1-api-reference/api/operation/GET_ListApplePayDomains/)[

post

Register an Apple Pay domain

](/v1-api-reference/api/operation/POST_RegisterApplePayDomain/)[

delete

Unregister an Apple Pay domain

](/v1-api-reference/api/operation/DELETE_UnregisterApplePayDomain/)[

post

Create a payment session

](/v1-api-reference/api/operation/POST_CreatePaymentSession/)
...
[Next to **Create a payment method**](/v1-api-reference/api/operation/POST_PaymentMethods/)
