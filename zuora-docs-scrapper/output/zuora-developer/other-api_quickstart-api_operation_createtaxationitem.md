---
title: "CreateTaxationItem"
url: "https://developer.zuora.com/other-api/quickstart-api/operation/createTaxationItem/"
product: "zuora-developer"
scraped_at: "2026-01-02T06:44:26.624Z"
---
...
| namerequired | string <= 128 charactersThe name of the taxation item. |
| amountrequired | numberThe amount of the tax applied to the total price. |
| tax_coderequired | stringA tax code identifier. If a tax_code of a price is not provided when you create or update a price, Zuora will treat the charged amount as non-taxable. If this code is provide, Zuora considers that this price is taxable and the charged amount will be handled accordingly. |
| tax_code_name | stringThe amount of the tax applied to the total price. |
| tax_daterequired | string <date>The date on which the tax is applied. |
| tax_raterequired | numberThe amount of the tax applied to the total price. |
