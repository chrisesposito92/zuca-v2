---
title: "QueryProductRatePlanChargeTierByKey"
url: "https://developer.zuora.com/v1-api-reference/api/operation/queryProductRatePlanChargeTierByKey/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:08:54.583Z"
---

## Retrieve a product rate plan charge tier

Retrieve the details of a specific Product Rate Plan Charge Tier object.
...
| keyrequired | stringID of a product rate plan charge tier. |
| --- | --- |
...
get/object-query/product-rate-plan-charge-tiers/{key}
...
curl \-i \-X GET \\
  'https://rest.test.zuora.com/object-query/product-rate-plan-charge-tiers/{key}?pageSize=10&cursor=string&sort%5B%5D=string&expand%5B%5D=productrateplancharge&filter%5B%5D=string&fields%5B%5D=string&includeNullFields=false' \\
