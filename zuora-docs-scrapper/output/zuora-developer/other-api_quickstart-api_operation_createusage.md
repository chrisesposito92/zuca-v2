---
title: "CreateUsage"
url: "https://developer.zuora.com/other-api/quickstart-api/operation/createUsage/"
product: "zuora-developer"
scraped_at: "2026-01-02T06:44:49.131Z"
---
...
| account_number | stringHuman-readable identifier of the account. It can be user-supplied. Either account_number or account_id is required. |
| --- | --- |
| account_id | stringIdentifier of the account associated with this subscription. Either account_id or account_number is required. |
| subscription_item_id | stringIdentifier of the subscription item. |
| subscription_item_number | stringHuman-readable identifier of the subscription item. |
...
| start_timerequired | string <date-time>The start time for which usage is recorded. |
| subscription_id | stringThe identifier of the subscription associated with the billing document item. |
| subscription_number | stringHuman-readable identifier of the subscription. It can be user-supplied. |
| unit_of_measurerequired | stringSpecifies the units to measure usage. Units of measure are configured in Zuora Central. Your values depend on your configuration in Billing Settings. |
