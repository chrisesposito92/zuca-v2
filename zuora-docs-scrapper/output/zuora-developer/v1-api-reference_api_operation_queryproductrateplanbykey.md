---
title: "QueryProductRatePlanByKey"
url: "https://developer.zuora.com/v1-api-reference/api/operation/queryProductRatePlanByKey/"
product: "zuora-developer"
scraped_at: "2026-01-02T07:08:56.364Z"
---

## Retrieve a product rate plan

Retrieve the details of a specific Product Rate Plan object.
...
| keyrequired | stringID of a product rate plan. |
| --- | --- |
...
get/object-query/product-rate-plans/{key}
...
curl \-i \-X GET \\
  'https://rest.test.zuora.com/object-query/product-rate-plans/{key}?pageSize=10&cursor=string&sort%5B%5D=string&expand%5B%5D=product&filter%5B%5D=string&fields%5B%5D=string&includeNullFields=false' \\
