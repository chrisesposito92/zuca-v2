---
title: "UpdateAccount"
url: "https://developer.zuora.com/other-api/quickstart-api/operation/updateAccount/"
product: "zuora-developer"
scraped_at: "2026-01-02T06:40:26.039Z"
---
...
| bill_to | object (AccountContactPatchRequest)Customer billing address. |
| sold_to | object (AccountContactPatchRequest)Customer address used for calculating tax. |
...
| name | stringThe name of the customer account. |
...
| currency | stringThree-letter ISO currency code. Once the currency is set for an account, it cannot be updated. |
