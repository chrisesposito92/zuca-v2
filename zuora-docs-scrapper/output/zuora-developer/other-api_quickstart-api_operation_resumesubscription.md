...
url: "https://developer.zuora.com/other-api/quickstart-api/operation/resumeSubscription/"
product: "zuora-developer"
scraped_at: "2026-01-02T06:41:41.811Z"
---
...
| extend_term | booleanDefault: falseIf this field is set to true, the subscription term is extended by the length of time the subscription is paused. |
| --- | --- |
| resume_date | stringDate on which the paused subscription is resumed. |
| resume_at | stringYou can use this field to resume a paused subscription from the pause date.Value: "pause_date" |
...
post/subscriptions/{subscription\_id}/resume
