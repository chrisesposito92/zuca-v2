---
title: "Debit memo item data mapping"
url: "https://docs.zuora.com/en/zuora-revenue/advanced-revenue-operations/mapping-between-zuora-billing-and-zuora-revenue_1/debit-memo-item-data-mapping"
product: "zuora-revenue"
scraped_at: "2025-12-24T04:41:29.832Z"
---

# Debit memo item data mapping

This document provides an overview of debit memo item data mapping between Zuora Billing and Zuora Revenue, including standard and custom field mappings.
...
Some standard fields of debit memo items in Zuora Billing are mapped to Zuora Revenue Staging fields. The following table describes the pre-defined debit memo item field mappings between Zuora Billing and Zuora Revenue Staging tables.
...
| DebitMemoItem.ServiceStartDate | Revenue Start Date | Date | The start date of the service period associated with this debit memo item. If the associated charge is a one-time fee, then this date is the date of that charge. |
| DebitMemoItem.ServiceEndDate | Revenue End Date | Date | The end date of the service period associated with this debit memo item. Service ends one second before the date in this value. |
...
| DebitMemoItem.AmountWithoutTax | Ext Sell Price | Number | The amount being charged for the debit memo item without tax. |
...
| Invoice.Id | Billing Id | Character | The unique ID of an invoice upon which the debit memo is created. |
| DebitMemoItem.Id | Billing Item Id | Character | The unique ID of a debit memo item. |
| DebitMemo.MemoNumber | Invoice Num | Character | The number of a debit memo. |
| DebitMemo.MemoDate | Invoice Date | Date | This field is the date when the debit memo is created. |
| DebitMemoItem.Quantity | Invoice Qty | Number | This field is used to capture the number of quantity invoiced for the given invoice line. |
...
| Zuora Billing Field | Zuora Revenue Staging Field Name | Input Value Type | Description |
| --- | --- | --- | --- |
| DebitMemo.BillToContact.FirstName | Any attribute from 1 to 60 (ATR1 - ATR60) | Character | The first name of the specified Bill To Contact for a debit memo. |
| DebitMemo.BillToContact.LastName | Any attribute from 1 to 60 (ATR1 - ATR60) | Character | The last name of the specified Bill To Contact for a debit memo. |
| DebitMemo.SoldToContact.FirstName | Any attribute from 1 to 60 (ATR1 - ATR60) | Character | The first name of the specified Sold To Contact for a debit memo. |
| DebitMemo.SoldToContact.LastName | Any attribute from 1 to 60 (ATR1 - ATR60) | Character | The last name of the specified Sold To Contact for a debit memo. |
