---
title: "Configure security policy settings for your organization"
url: "https://docs.zuora.com/en/zuora-revenue/advanced-revenue-operations/oneid-settings/password-rotation-and-password-length"
product: "zuora-revenue"
scraped_at: "2025-12-24T04:44:39.279Z"
---

# Configure security policy settings for your organization

Learn how to configure security policy settings to enhance password protection and tailor security measures to your organization's needs.
...
1.  Navigate to the OneID portal and click on your user profile located at the top right corner.
2.  Click Settings.
3.  Select Security Policies from the menu.
4.  Click on Edit on the Security Policies page.
5.  Adjust and update the security policy parameters as needed.
6.  Click Save.
...
| Strengthen your organization's security by implementing password protection measures with Zuora's security policies. Set password history, length, and complexity requirements. Additionally, establish password reset procedures for enhanced security.The following security policies are available within OneID for administrators to implement at the organizational level: |  |
| --- | --- |
...
## Password rotation and password length

Zuora recommends rotating passwords at least once every 90 days and maintaining a password length of 12 characters.
