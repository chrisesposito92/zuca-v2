...
Learn about recording manual journal entries, setting up Zuora Revenue, and managing MJE uploads and validations.
...
In Zuora Revenue, you must complete certain setups before revenue can be released based on the uploaded MJE. For more information, see [MJE setups](/zuora-revenue/month-end-process/manual-journal-entries/mje-setups) .
