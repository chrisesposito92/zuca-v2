...
url: "https://docs.zuora.com/en/zuora-revenue/getting-started/system-management/configure-accounting-structure_1/create-account-types"
product: "zuora-revenue"
scraped_at: "2026-02-20T21:18:00.079Z"
---

# Create account types

Learn how to create account types in Zuora Revenue to facilitate accurate data processing by debiting or crediting the appropriate accounts by following the steps provided below.
...
4.  To add an account, click the '+' icon . The New Account Type window is displayed.
...
8.  Click the save icon. The account type is created.
