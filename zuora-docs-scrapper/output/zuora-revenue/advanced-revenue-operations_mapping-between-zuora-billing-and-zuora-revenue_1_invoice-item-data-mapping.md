---
title: "Invoice item data mapping"
url: "https://docs.zuora.com/en/zuora-revenue/advanced-revenue-operations/mapping-between-zuora-billing-and-zuora-revenue_1/invoice-item-data-mapping"
product: "zuora-revenue"
scraped_at: "2025-12-24T04:41:19.790Z"
---

# Invoice item data mapping

Zuora Billing fields are mapped to Zuora Revenue Staging fields for invoice lines, with predefined mappings and customizable options.

## Standard field mapping

Some standard fields in Zuora Billing are mapped to Zuora Revenue Staging fields for invoice lines. The following table describes the pre-defined invoice item field mappings between Zuora Billing and Zuora Revenue Staging tables.
...
-   Zuora RevenueStaging Field Name: The user-friendly name for Zuora Revenue Staging fields.
-   Input Value Type: The data type of the field.
-   Description: Additional information on field mappings.

Note: The tax-related fields are not extracted from Zuora Billing as part of the invoice item data extraction.
...
| InvoiceItem.ServiceStartDate | Revenue Start Date | Date | The start date of the service period associated with this invoice item. If the associated charge is a one-time fee, then this date is the date of that charge. |
...
| Invoice.InvoiceNumber | Invoice Num | Character | This is used to identify an invoice number and its corresponding items in Zuora Revenue. |
| Invoice.InvoiceDate | Invoice Date | Date | This field is the invoice date and it is used to collect data into Zuora Revenue based on the current open period in Zuora Revenue. |
