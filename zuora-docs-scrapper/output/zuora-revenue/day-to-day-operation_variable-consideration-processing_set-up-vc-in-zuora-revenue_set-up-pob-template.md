---
title: "Set up POB template"
url: "https://docs.zuora.com/en/zuora-revenue/day-to-day-operation/variable-consideration-processing/set-up-vc-in-zuora-revenue/set-up-pob-template"
product: "zuora-revenue"
scraped_at: "2026-02-20T21:19:16.143Z"
---

# Set up POB template

Learn how to set up a POB template and map VC types in Zuora Revenue.

After the VC policies are set up, the defined VC type must be mapped to appropriate POB templates.

If POB template does not exist in Zuora Revenue yet, create it. For more information, see [Create POB Template](/zuora-revenue/getting-started/policy-management/performance-obligations-processing/create-pob-template) .
...
5.  Save your changes by clicking the save icon and close the window.
    ...
    For information about how to manually upload VC to Zuora Revenue, see [VC Upload.](/zuora-revenue/day-to-day-operation/variable-consideration-processing/vc-upload)
