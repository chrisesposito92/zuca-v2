...
export const ChargeSchema = z.object({
  ...
  listPriceBase: z.string().optional(),
  triggerEvent: z.string(),
  specificTriggerDate: z.string().optional(),
  endDateCondition: z.string().optional(),
  specificEndDate: z.string().optional(),
  ...
  chargeFunction: ChargeFunctionSchema.optional(),
  isAllocationEligible: z.boolean().optional(),
  drawdownType: z.string().optional(),
  commitmentType: z.string().optional(),
  prepaymentUOM: z.string().optional(),
  prepaymentUnits: z.number().optional(),
...
export const SubscriptionSchema = z.object({
  ...
  initialTermPeriodType: z.enum(['Month', 'Year']).optional(),
  renewalTerm: z.number().optional(),
  renewalTermPeriodType: z.enum(['Month', 'Year']).optional(),
